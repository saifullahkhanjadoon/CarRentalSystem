...
public class Clint extends User{
    ...
    private JButton[] btns=new JButton[]{
        ...
        new JButton("Rent Cars",22),
        new JButton("Return Cars",22),
...
public void showList(Database database,JFrame f){
      JFrame frame =new JFrame("Clint Panel");
        frame.setSize(400,btns.length*90);
        frame.setLocationRelativeTo(f);
        frame.getContentPane().setBackground(new Color(250,06,27));
        ...
        for(int i=0;i<btns.length;i++){
            ...
            button.addActionListener(new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e){
                    operations[j].operation(database, f, Clint.this);
                }
              });
        }
