        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                if (oldPassword.getText().equals("")) {
                    JOptionPane.showMessageDialog(frame, "Old Password cann't be empty");
                    return;
                }
                if (newPassword.getText().equals("")) {
                    JOptionPane.showMessageDialog(frame, "New Password cann't be empty");
                    return;
                }
                if (confirmPassword.getText().equals("")) {
                    JOptionPane.showMessageDialog(frame, "Comfirm Password cann't be empty");
                    return;
                }
                if (!oldPassword.getText().equals(user.getPasword())) {
                ...
                try {
                    ...
                    user.setPasword(newPassword.getText());
                    frame.dispose();
