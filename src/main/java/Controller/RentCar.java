...
import javax.swing.JComboBox; // corrected: using standard JComboBox
...
public class RentCar implements Operation {
    ...
    public void operation(Database database, JFrame f, User user) {
        ...
        JLabel title = new JLabel("Rent Car", JLabel.CENTER); 
        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (hours.getText().equals("")) {
                    JOptionPane.showMessageDialog(frame, "Hours cann't be empty");
                    return;
                }
                int hoursInt;
                try {
                ...
                try {
                    ...
                    if (car.isAvailable() != 0) {
                        JOptionPane.showMessageDialog(frame, "Car isn'tt Available!");
                        return;
                    }

                    ResultSet rs1 = database.getStatement().executeQuery("SELECT COUNT(*) AS total FROM `rents`;");
                    rs1.next();
                    int ID = rs1.getInt("total");
    ...
    private void updateData(String ID) {
        if (ID.equals(" ")) {
            ...
            try {
                ...
                price.setText(String.valueOf(rs1.getDouble("Price")) + " Rs");
            } catch (Exception e1) {
