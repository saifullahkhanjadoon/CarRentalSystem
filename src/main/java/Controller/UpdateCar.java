                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if (id.getSelectedItem().toString().equals(" ")) {
                            JOptionPane.showMessageDialog(frame, "ID cann't be empty");
                            return;
                        }
                        if (brand.getText().equals("")) {
                            JOptionPane.showMessageDialog(frame, "Brand cann't be empty");
                            return;
                        }

                        if (color.getText().equals("")) {
                            JOptionPane.showMessageDialog(frame, "Color cann't be empty");
                            return;
                        }

                        if (year.getText().equals("")) {
                            JOptionPane.showMessageDialog(frame, "Year cann't be empty");
                            return;
                        }

                        if (price.getText().equals("")) {
                            JOptionPane.showMessageDialog(frame, "price cann't be empty");
                            return;
                        }
                        ...
                        try {
                            String update = "UPDATE cars SET Brand='" + brand.getText() + "',"
                                    + "Model='" + model.getText() + "',Color='" + color.getText() + "',"
                                    + "Year='" + yearInt + "',Price='" + priceDoub + "' WHERE ID='" + id.getSelectedItem().toString() + "';";

                            database.getStatement().execute(update);
                            JOptionPane.showMessageDialog(frame, "Car updated sucessfully!");
                            frame.dispose();
